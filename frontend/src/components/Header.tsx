            ...
            <div className="max-w-7xl mx-auto grid grid-cols-3 items-center">
                ...
                <div className="flex justify-start">
                    <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        className="w-16 h-16 lg:w-10 lg:h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-white/10 transition-colors"
                    >
                        <User className="w-8 h-8 lg:w-5 lg:h-5 text-text/80" />
                    </motion.button>
                </div>
                ...
                <div className="flex justify-center">
                    <motion.h1
                        ...
                        className="text-6xl lg:text-5xl font-mono tracking-wider text-primary drop-shadow-sm cursor-default"
                    >
                        SCOARD
                    </motion.h1>
                </div>
                ...
                <div className="flex justify-end relative">
                    <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                        className="flex items-center gap-2 px-8 py-4 lg:px-4 lg:py-2 rounded-lg glass hover:bg-white/5 transition-all duration-300 border border-white/10 hover:border-accent/50 group"
                    >
                        <span className="font-bold lg:font-medium font-display group-hover:text-accent transition-colors text-2xl lg:text-base">NBA</span>
                        <motion.div
                            animate={{ rotate: isSportOpen ? 180 : 0 }}
                            transition={{ duration: 0.2 }}
                        >
                            <ChevronDown className="w-8 h-8 lg:w-4 lg:h-4 text-text/60" />
                        </motion.div>
                    </motion.button>
